 ...
 */
async function checkVerificationStatuses(sim: TenderlySimulation, addresses: string[], provider: JsonRpcProvider): Promise<string[]> {
  const info: string[] = []
 ...
 */
async function checkVerificationStatus(sim: TenderlySimulation, addr: string, provider: JsonRpcProvider): Promise<'verified' | 'eoa' | 'unverified'> {
