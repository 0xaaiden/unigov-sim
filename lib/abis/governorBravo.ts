export const GOVERNOR_BRAVO_ABI = [
  ...
  { constant: false, inputs: [], name: '_acceptAdmin', outputs: [], payable: false, stateMutability: 'nonpayable', type: 'function' },
  {
    constant: false,
    inputs: [{ internalType: 'uint256', name: 'proposalCount', type: 'uint256' }],
    name: '_initiate',
    outputs: [],
    payable: false,
  ...
  },
  {
    ...
    inputs: [{ internalType: 'uint256', name: 'proposalId', type: 'uint256' }],
    name: 'state',
    outputs: [{ internalType: 'enum GovernorBravoDelegateStorageV1.ProposalState', name: '', type: 'uint8' }],
    payable: false,
    stateMutability: 'view',
    type: 'function',
  },
  ...
  },
  {
    ...
    inputs: [],
    name: 'uni',
    outputs: [{ internalType: 'contract UniInterface', name: '', type: 'address' }],
    payable: false,
    stateMutability: 'view',
    type: 'function',
  },
